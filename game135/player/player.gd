...
func update_health_bar() -> void:
	...
	if not health_progress_bar:
		health_progress_bar = $HealthProgressBar
...
func die() -> void:
	...
	print("Player morreu!")
# Chamar trigger_game_over para iniciar a tela de game over
	get_tree().root.get_node("Main").trigger_game_over()
...
func heal(amount: int) -> int:
	...
	if health > max_health:
		health = max_health
	print("Recebeu ", amount, " de vida. Total: ", health, "/", max_health)
	return health
